...
.tag{font-family:var(--mo);font-size:.54rem;letter-spacing:.11em;text-transform:uppercase;color:var(--ac);background:rgba(58,123,213,.12);border:1px solid rgba(58,123,213,.28);border-radius:3px;padding:.18rem .5rem;margin-right:6px;display:inline-block;margin-bottom:5px;}
...
.tbl-wrap{background:var(--sf);border:1px solid var(--bd);border-radius:5px;overflow:hidden;}
